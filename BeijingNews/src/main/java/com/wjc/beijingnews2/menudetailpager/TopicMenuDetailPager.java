...
import com.wjc.beijingnews2.menudetailpager.tabdetailpager.TopicDetailPager;
 ...
 * WeChat：wjc398556712
 * Function：专题详情页面  用Tablayout代替TabPageIndicator
 */
...
//    private TabPageIndicator tabPageIndicator;
     ...
     */
    public TopicMenuDetailPager(Context context, NewsCenterPagerBean2.NewsCenterPagerData detailPagerData) {
        super(context);
    ...
    public void initData() {
        ...
        for (int i = 0; i < childrens.size(); i++) {
            tabDetailPagers.add(new TopicDetailPager(context, childrens.get(i)));
        }
        //设置ViewPager的适配器
